      ...
      <section className="relative w-full max-w-7xl mx-auto px-6 pt-20 pb-32 flex flex-col items-center text-center mt-10">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-slate-500 dark:text-slate-400 mb-10 max-w-2xl mx-auto leading-relaxed">
            Escanea códigos de barras, controla tus intercambios, mantén tu stock al día y comparte tu catálogo virtual con clientes en segundos. Todo desde tu celular o computadora.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <FeatureCard 
              icon={<Shield size={32} />}
              title="Intercambios"
              desc="Lleva un registro de qué producto intercambiaste, con alertas de fecha de vencimiento para que nunca pierdas mercadería."
              color="text-blue-500"
